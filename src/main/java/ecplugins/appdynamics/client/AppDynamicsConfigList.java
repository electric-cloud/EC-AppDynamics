...
// AppDynamicsConfigList.java --
//
// AppDynamicsConfigList.java is part of ElectricCommander.
//
...
public class AppDynamicsConfigList
{

    //~ Instance fields --------------------------------------------------------

    private final Map<String, AppDynamicsConfigInfo> m_configInfo =
        new TreeMap<String, AppDynamicsConfigInfo>();
    ...
    public void addConfig(
            ...
            String configServer)
    {
        m_configInfo.put(configName, new AppDynamicsConfigInfo(configServer));
    }
    ...
    private class AppDynamicsConfigInfo
    {
        ...
        public AppDynamicsConfigInfo(String server)
        {
            m_server = server;
        }
    }
