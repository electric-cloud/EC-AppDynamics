...
/**
 * EC-AppDynamics Configuration List.
 */
    ...
    extends ListBase
{
    ...
    private AppDynamicsConfigList m_configList;

    //~ Constructors -----------------------------------------------------------

    public ConfigurationList()
    {
        super("ecgc", "AppDynamics Configurations", "All Configurations");
        m_configList = new AppDynamicsConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        AppDynamicsConfigListLoader loader = new AppDynamicsConfigListLoader(m_configList, this,
                new ChainedCallback() {
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/EC-AppDynamics/project");
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            DialogClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the AppDynamics configuration '"
                            + configName + "'?") {
    ...
    private void waitForJob(final String jobId)
    {
        CgiRequestProxy     cgiRequestProxy = new CgiRequestProxy(
                getPluginName(), "appdynamicsMonitor.cgi");
